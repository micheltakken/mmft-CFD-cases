...
def generateCSV(folder):
    ...
    plotOverLineA.Point1 = [0.001, 0.00092929, 5e-5]
    plotOverLineA.Point2 = [0.00110607, 0.00096464, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineB = PlotOverLine(registrationName='PlotOverLineB', Input=filefoam)
    plotOverLineB.Point1 = [0.00110607, 0.00096464, 5e-5]
    plotOverLineB.Point2 = [0.00096464, 0.00110607, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineC = PlotOverLine(registrationName='PlotOverLineC', Input=filefoam)
    plotOverLineC.Point1 = [0.00296464, 0.00089393, 5e-5]
    plotOverLineC.Point2 = [0.00289393, 0.00096464, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineD = PlotOverLine(registrationName='PlotOverLineD', Input=filefoam)
    plotOverLineD.Point1 = [0.00289393, 0.00096464, 5e-5]
    plotOverLineD.Point2 = [0.00303535, 0.00110606, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineE = PlotOverLine(registrationName='PlotOverLineE', Input=filefoam)
    plotOverLineE.Point1 = [0.00296464, 0.00089393, 5e-5]
    plotOverLineE.Point2 = [0.00310606, 0.00103535, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineF = PlotOverLine(registrationName='PlotOverLineF', Input=filefoam)
    plotOverLineF.Point1 = [0.00310606, 0.00103535, 5e-5]
    plotOverLineF.Point2 = [0.00303535, 0.00110606, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineG = PlotOverLine(registrationName='PlotOverLineG', Input=filefoam)
    plotOverLineG.Point1 = [0.00503535, 0.00089393, 5e-5]
    plotOverLineG.Point2 = [0.00489393, 0.0010353, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineH = PlotOverLine(registrationName='PlotOverLineH', Input=filefoam)
    plotOverLineH.Point1 = [0.00489393, 0.0010353, 5e-5]
    plotOverLineH.Point2 = [0.00496464, 0.00110606, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineI = PlotOverLine(registrationName='PlotOverLineI', Input=filefoam)
    plotOverLineI.Point1 = [0.00503535, 0.00089393, 5e-5]
    plotOverLineI.Point2 = [0.00510606, 0.00096464, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineJ = PlotOverLine(registrationName='PlotOverLineJ', Input=filefoam)
    plotOverLineJ.Point1 = [0.00510606, 0.00096464, 5e-5]
    plotOverLineJ.Point2 = [0.00496464, 0.00110606, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineK = PlotOverLine(registrationName='PlotOverLineK', Input=filefoam)
    plotOverLineK.Point1 = [0.007, 0.00092929, 5e-5]
    plotOverLineK.Point2 = [0.00689393, 0.00096464, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineL = PlotOverLine(registrationName='PlotOverLineL', Input=filefoam)
    plotOverLineL.Point1 = [0.00689393, 0.00096464, 5e-5]
    plotOverLineL.Point2 = [0.00703535, 0.00110606, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineM = PlotOverLine(registrationName='PlotOverLineM', Input=filefoam)
    plotOverLineM.Point1 = [0.007, 0.00092929, 5e-5]
    plotOverLineM.Point2 = [0.00707071, 0.001, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineN = PlotOverLine(registrationName='PlotOverLineN', Input=filefoam)
    plotOverLineN.Point1 = [0.00707071, 0.001, 5e-5]
    plotOverLineN.Point2 = [0.00703535, 0.00110606, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineO = PlotOverLine(registrationName='PlotOverLineO', Input=filefoam)
    plotOverLineO.Point1 = [0.00796464, -0.00003535, 5e-5]
    plotOverLineO.Point2 = [0.00803535, 0.00003535, 5e-5]

    # create a new 'Plot Over Line'
    plotOverLineP = PlotOverLine(registrationName='PlotOverLineP', Input=filefoam)
    plotOverLineP.Point1 = [0.00803535, 0.00196464, 5e-5]
    plotOverLineP.Point2 = [0.00796464, 0.00203535, 5e-5]
    ...
    plotOverLineM.Resolution = 1000
    plotOverLineN.Resolution = 1000
    plotOverLineO.Resolution = 1000
    plotOverLineP.Resolution = 1000
    ...
    SaveData(folder+'M-M.csv', proxy=plotOverLineM, PointDataArrays=['C', 'arc_length'])
    SaveData(folder+'N-N.csv', proxy=plotOverLineN, PointDataArrays=['C', 'arc_length'])
    SaveData(folder+'O-O.csv', proxy=plotOverLineO, PointDataArrays=['C', 'arc_length'])
    SaveData(folder+'P-P.csv', proxy=plotOverLineP, PointDataArrays=['C', 'arc_length'])
