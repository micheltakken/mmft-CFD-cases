...
concentrationFieldOpenFOAMDisplay.ScaleFactor = 0.0008070710588071961
...
concentrationFieldOpenFOAMDisplay.GaussianRadius = 4.0353552940359805e-05
...
concentrationFieldOpenFOAMDisplay.ScaleTransferFunction.Points = [-5.263267667032778e-06, 0.0, 0.5, 0.0, 0.012971850112080574, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
concentrationFieldOpenFOAMDisplay.OpacityTransferFunction.Points = [-5.263267667032778e-06, 0.0, 0.5, 0.0, 0.012971850112080574, 1.0, 0.5, 0.0]
...
slice1.SliceType.Origin = [0.003999999953521183, 0.001000000032945536, 4.999999873689376e-05]

# init the 'Plane' selected for 'HyperTreeGridSlicer'
slice1.HyperTreeGridSlicer.Origin = [0.003999999953521183, 0.001000000032945536, 4.999999873689376e-05]
...
slice1Display.ScaleFactor = 0.0008070710588071961
slice1Display.SelectScaleArray = 'C'
slice1Display.GlyphType = 'Arrow'
slice1Display.GlyphTableIndexArray = 'C'
slice1Display.GaussianRadius = 4.0353552940359805e-05
...
# change scalar bar placement
cLUTColorBar.Position = [0.936986301369863, 0.014687882496940025]

# change scalar bar placement
cLUTColorBar.WindowLocation = 'Any Location'
cLUTColorBar.Position = [0.05388127853881285, 0.3365973072215422]
cLUTColorBar.ScalarBarLength = 0.33000000000000035

# change scalar bar placement
cLUTColorBar.Position = [0.020091324200913308, 0.33904528763769887]
cLUTColorBar.ScalarBarLength = 0.33000000000000046
...
renderView1.CameraPosition = [0.003868236188356656, 0.0009648630289016615, 0.01344196623466067]
renderView1.CameraFocalPoint = [0.003868236188356656, 0.0009648630289016615, 4.999999873689376e-05]
renderView1.CameraParallelScale = 0.004193976055004659

# save screenshot
SaveScreenshot('/home/michel/Git/mmft-CFD-cases/DiffusiveMixing/grid-mixer/concentrationField/grid-concentration-result.png', renderView1, ImageResolution=[1095, 817],
