...
def main():
    ...
    if (node2[0] >= node2[1]):
        ...
        vertices2[0] = np.array([vertices[2][0], node2[1]])
        vertices2[1] = np.array([vertices[8][0], node2[1]])
        vertices2[2] = np.array([vertices[2][0] - np.sin(beta)*channelWidth, vertices[2][1] + np.cos(beta)*channelWidth])
        vertices2[3] = np.array([vertices[6][0] - np.sin(beta)*channelWidth, vertices[6][1] - np.cos(beta)*channelWidth])
        vertices2[4] = np.array([vertices[8][0] + np.sin(beta)*channelWidth, vertices[8][1] + np.cos(beta)*channelWidth])
        vertices2[5] = np.array([vertices[13][0] + np.sin(beta)*channelWidth, vertices[13][1] - np.cos(beta)*channelWidth])
