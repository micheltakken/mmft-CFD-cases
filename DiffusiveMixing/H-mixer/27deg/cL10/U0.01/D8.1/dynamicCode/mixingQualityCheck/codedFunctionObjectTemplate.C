...
{
    // dynamicCode:
    // SHA1 = c02623056b6dcd01f746e751a7731192a5e7c92a
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void mixingQualityCheck_c02623056b6dcd01f746e751a7731192a5e7c92a(bool load)
    {
        if (load)
        {
...
bool mixingQualityCheckFunctionObject::read(const dictionary& dict)
{
    if (false)
    {
        Info<<"read mixingQualityCheck sha1: c02623056b6dcd01f746e751a7731192a5e7c92a\n";
    }
...
Foam::wordList mixingQualityCheckFunctionObject::fields() const
{
    if (false)
    {
        Info<<"fields mixingQualityCheck sha1: c02623056b6dcd01f746e751a7731192a5e7c92a\n";
    }
...
bool mixingQualityCheckFunctionObject::execute()
{
    if (false)
    {
        Info<<"execute mixingQualityCheck sha1: c02623056b6dcd01f746e751a7731192a5e7c92a\n";
    }

//{{{ begin code
    #line 71 "/home/michel/Git/mmft-CFD-cases/DiffusiveMixing/H-mixer/27deg/cL10/U0.01/D8.1/system/controlDict/functions/mixingQualityCheck"
...
bool mixingQualityCheckFunctionObject::write()
{
    if (false)
    {
        Info<<"write mixingQualityCheck sha1: c02623056b6dcd01f746e751a7731192a5e7c92a\n";
    }
...
bool mixingQualityCheckFunctionObject::end()
{
    if (false)
    {
        Info<<"end mixingQualityCheck sha1: c02623056b6dcd01f746e751a7731192a5e7c92a\n";
    }
